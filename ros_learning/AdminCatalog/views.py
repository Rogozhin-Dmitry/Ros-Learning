...
class Courses(View):
    def get(self, request, *args, **kwargs):
        context = {"courses": Controll.get_user_courses(request.user.id)}
...
class Lessons(View):
    ...
    def delete(self, request, *args, **kwargs):
        context = {"lessons": Controll.get_courses_lessons(kwargs["courses_pk"])}
        return render(request, "lessons/lessons.html", context=context)


class Tasks(View):
    def get(self, request, *args, **kwargs):
        return render(request, "tasks/tasks.html", {"tasks": Controll.get_courses_lessons(kwargs["courses_pk"])})
    ...
    def delete(self, request, *args, **kwargs):
        context = {"tasks": Controll.get_lessons_tasks(kwargs["courses_pk"], kwargs["lesson_pk"])}
